...
function Footer() {
  return (
    <>
      <section className="bg_Blue rounded-4 py-5 mx-md-3  position-relative mt-5">
        <img
            ...
            <div className="row justify-content-between align-items-center">
              <div className="col-md-8">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <textarea
                      className=" w-100 pt_10_custom pb-5 px-2 rounded-2 bg_primary outline_none fw-semibold fs_xl text_greyLight mt-4 mt-lg-0"
                      placeholder="Message.."
                    ></textarea>
                    <a
              ...
              <div className="col-md-3">
                ...
                <p className=" fw-normal fs_xl text_lightgray mt-4">
                  ...
                  <div className="col-6">
                    ...
                    <div className=" d-flex flex-column">
                      <span className=" d-inline-block mt-3 mb-1">
                        <a
                          className=" fw-semibold fs_xl text-white footer_hover_link"
                          href="#"
                        >
                          Pricing
                        </a>
            ...
            <div className="row justify-content-between mt-md-4 pt-md-2">
              <div className="col-md-6">
                <div className="d-md-flex justify-content-between">
                  ...
                  <a
                    className=" fw-normal fs_lg text_grey me-4 after_link_line position-relative px-xl-3 d-inline-block mt-3 mt-md-0 last_link"
                    href="#"
                  >
                    Do not sell my data
                  </a>
              ...
              <div className="col-md-4">
                <div className="d-md-flex mt-4 mt-md-0">
                  <a
                    className=" fw-normal fs_lg text_grey me-md-4 after_link_line position-relative px-xl-3 last_link"
                    href="#"
                  >
                    Terms & Conditions
                  </a>
                  <a
                    className=" fw-normal fs_lg text_grey me-4 after_link_line position-relative px-xl-3 ms-5 ms-sm-4 last_link"
                    href="#"
                  >
                    Privacy Policy
                  </a>
