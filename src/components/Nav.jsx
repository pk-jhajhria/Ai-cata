...
import cross_btn from "../assets/img/png/cros btn.png";
...
import nav_bg from "../assets/img/png/nav_bg.png";
  ...
  return (
    <>
      <section className="py-lg-3 pb-3 position-relative">
        <img
          className=" position-absolute top-0 start-0 z_index_1 d-none d-md-block"
          src={nav_bg}
          alt="nav_bg"
        />
